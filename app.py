                ...
                dbc.Row(
                 [
                     ...
                     dbc.Col(dbc.ListGroupItem("Regular font",
                                href=f"{configs['PLACEFILES_LINKS']}/latest_surface_observations_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem("Large font",
                                href=f"{configs['PLACEFILES_LINKS']}/latest_surface_observations_lg_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem("Small font",
                                href=f"{configs['PLACEFILES_LINKS']}/latest_surface_observations_xlg_shifted.txt",
                                target="_blank"), width=2),
                 ],
                 style={"display": "flex", "flexWrap": "wrap"}
                ),
                dbc.Row(
                 [
                     ...
                     dbc.Col(dbc.ListGroupItem("Wind",
                                href=f"{configs['PLACEFILES_LINKS']}/wind_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem("Temp",
                                href=f"{configs['PLACEFILES_LINKS']}/temp_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem("Dwpt",
                                href=f"{configs['PLACEFILES_LINKS']}/dwpt_shifted.txt",
                                target="_blank"), width=2),
                ...
                dbc.Row(
                 [
                     ...
                     dbc.Col(dbc.ListGroupItem("Effective",
                                href=f"{configs['PLACEFILES_LINKS']}/ebwd_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem("0-1 SHR",
                                href=f"{configs['PLACEFILES_LINKS']}/shr1_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem("0-3 SHR",
                                href=f"{configs['PLACEFILES_LINKS']}/shr3_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem("0-6 SHR",
                                href=f"{configs['PLACEFILES_LINKS']}/shr6_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem("0-8 SHR",
                                href=f"{configs['PLACEFILES_LINKS']}/shr8_shifted.txt",
                                target="_blank"), width=2),
                 ],
                 style={"display": "flex", "flexWrap": "wrap"},
                ),
                dbc.Row(
                 [
                     dbc.Col(dbc.ListGroupItem("NSE SRH"),
                             style=lc.group_item_style, width=2),
                     dbc.Col(dbc.ListGroupItem("Effective",
                                href=f"{configs['PLACEFILES_LINKS']}/esrh_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem("0-500m",
                                href=f"{configs['PLACEFILES_LINKS']}/srh500_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem(" "), width=2),
                     dbc.Col(dbc.ListGroupItem(" "), width=2),
                ...
                dbc.Row(
                 [
                     ...
                     dbc.Col(dbc.ListGroupItem("MLCAPE",
                                href=f"{configs['PLACEFILES_LINKS']}/mlcape_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem("MLCIN",
                                href=f"{configs['PLACEFILES_LINKS']}/mlcin_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem("0-3 MLCP",
                                href=f"{configs['PLACEFILES_LINKS']}/cape3km_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem("0-3 LR",
                                href=f"{configs['PLACEFILES_LINKS']}/lr03km_shifted.txt",
                                target="_blank"), width=2),
                     dbc.Col(dbc.ListGroupItem("MUCAPE",
                                href=f"{configs['PLACEFILES_LINKS']}/mucape_shifted.txt",
                                target="_blank"), width=2),
                 ],
                 style={"display": "flex", "flexWrap": "wrap"},
                ),
