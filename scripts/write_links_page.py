...
<div class="container">
    <br><br>
    <h3><a href="https://docs.google.com/document/d/1uAcsjzjTAl6SA4dKgcj3pIpM__X-yfH0OGVsdam4dQw/edit" target="_blank">RSSiC User Guide</a></h3>
    <br><hr><br>
    <h3>Right-click polling link and copy address into GR2Analyst</h3>
    <p><i><a href="https://rssic.nws.noaa.gov/assets/docs/GR2Analyst_Polling_Guide.pdf" target="_blank">(GR2Analyst polling settings guide)</a></i></p>
    ...
    <p><i><a href="https://rssic.nws.noaa.gov/assets/docs/GR2Analyst_Placefiles_Guide.pdf" target="_blank">(GR2Analyst placefile settings guide)</a></i></p>
    <br>
    <div class="container">
    <div class="container">
    <h4>Surface Obs</h4>
...
<br><hr><br>
		<div id="main">
			<div id="content" class="container">
				...
				<p style = "font-size:175%"><b><u>Instability</u></b></p>
				<ul>	
					<li style = "font-size:135%", align = "left"><b>Mixed Layer CAPE</b></li>
						<ul><li align = "left">MLCAPE (Mixed Layer Convective Available Potential Energy) 
					...
					<li style = "font-size:135%", align = "left"><b>Mixed Layer CIN</b></li>
						<ul><li align = "left">CIN (Convective INhibition) represents the "negative" area on a sounding that must be overcome before storm initiation can occur.
						</li></ul>
					<li style = "font-size:135%", align = "left"><b>Mixed Layer LCL</b></li>
						<ul><li align = "left">The LCL (Lifting Condensation Level) is the level at which a parcel becomes saturated. It is a reasonable estimate of cloud base height when parcels experience forced ascent.
						</li></ul>
					<li style = "font-size:135%", align = "left"><b>Most Unstable CAPE</b></li>
						<ul><li align = "left"> MUCAPE (Most Unstable Convective Available Potential Energy) is a measure of instability in the troposphere. This value represents the total amount of potential energy available to the maximum equivalent potential temperature (within the lowest 300-mb of the atmosphere) while being lifted to its level of free convection (LFC). No parcel entrainment is considered. The CAPE and CIN calculations use the virtual temperature correction.
						</li></ul>
					<li style = "font-size:135%", align = "left"><b>0-3km CAPE</b></li>
						<ul><li align = "left">CAPE in the lowest 3-km above ground level. Areas of large 0-3-km CAPE tend to favor strong low-level stretching, and can support tornado formation when co-located with significant vertical vorticity near the ground.
						</li></ul>
					<li style = "font-size:135%", align = "left"><b>0-3km Lapse Rate</b></li>
						<ul><li align = "left">A lapse rate is the rate of temperature change with height. The faster the temperature decreases with height, the "steeper" the lapse rate and the more "unstable" the atmosphere becomes. The 0-3 km lapse rates, also referred to as low-level lapse rates, are meant to identify regions of deeper mixing (e.g., steeper lapse rates) that often result in weakening convective inhibition that precedes surface-based thunderstorm development, as well as the potential for strong downdrafts in the low levels.
						</li></ul>
				</ul>
				<br><br>
				<p style = "font-size:175%"><b><u>Shear</u></b></p>
				<ul>
					<li style = "font-size:135%", align = "left"><b>0-1km Shear</b></li>
						<ul><li align = "left">Surface-1-km Vertical Shear is the difference between the surface wind and the wind at 1-km above ground level. These data are plotted as vectors. 0-1-km shear magnitudes greater than 15-20 knots tend to favor supercell tornadoes.
						</li></ul>
					<li style = "font-size:135%", align = "left"><b>0-3km Shear</b></li>
						<ul><li align = "left">Surface-3-km Vertical Shear is the difference between the surface wind and the wind at 3-km above ground level. Line-normal 0-3 km shear magnitudes of 30 kt or higher indicate a favorable environment for the development of mesovortices and/or tornadoes in QLCSs (Schaumann and Przybylinski 2012). These data are plotted as vectors.
						</li></ul>
					<li style = "font-size:135%", align = "left"><b>0-6km Shear</b></li>
						<ul><li align = "left">The surface through 6-km above ground level shear vector denotes the change in wind throughout this height. Thunderstorms tend to become more organized and persistent as vertical shear increases. Supercells are commonly associated with vertical shear values of 35-40 knots and greater through this depth.
						</li></ul>
					<li style = "font-size:135%", align = "left"><b>0-8km Shear</b></li>
						<ul><li align = "left">The surface through 8 km above ground level shear vector denotes the change in wind throughout this height. Thunderstorms tend to become more organized and persistent as vertical shear increases. Bunkers et al. 2006 found that long-lived supercells occur in environments with much stronger 0-8-km bulk wind shear ( > 50 kt) than that observed with short-lived supercells.
						</li></ul>
					<li style = "font-size:135%", align = "left"><b>Effective Bulk Shear</b></li>
						<ul><li align = "left">The magnitude of the vector wind difference from the effective inflow base upward to 50% of the equilibrium level height for the most unstable parcel in the lowest 300 mb. This parameter is similar to the 0-6 km bulk wind difference, though it accounts for storm depth (effective inflow base to EL) and is designed to identify both surface-based and "elevated" supercell environments. Supercells become more probable as the effective bulk wind difference increases in magnitude through the range of 25-40 kt and greater.
						</li></ul>
					<li style = "font-size:135%", align = "left"><b>0-500m Storm Relative Helicity</b></li>
						<ul><li align = "left">SRH (Storm Relative Helicity) in the lowest 500 m AGL has been found by Coffer et al. (2019), October issue of Weather and Forecasting, to be a better discriminator than effective SRH between significant tornadoes and nontornadic supercells. This calculation of 0-500 m SRH is limited to within the effective inflow layer, as long as the inflow base is at the ground.
						</li></ul>
					<li style = "font-size:135%", align = "left"><b>0-1km Storm Relative Helicity</b></li>
						<ul><li align = "left">SRH (Storm Relative Helicity) is a measure of the potential for cyclonic updraft rotation in right-moving supercells. There is no clear threshold value for SRH when forecasting supercells, since the formation of supercells appears to be related more strongly to the deeper layer vertical shear. Larger values of 0-1-km SRH (greater than 100 m2 s-2), however, do suggest an increased threat of tornadoes with supercells. For SRH, larger values are generally better, but there are no clear thresholds between non-tornadic and significant tornadic supercells.
						</li></ul>
					<li style = "font-size:135%", align = "left"><b>Effective Storm Relative Helicity</b></li>
						<ul><li align = "left">Effective SRH (Storm Relative Helicity) is based on threshold values of lifted parcel CAPE (100 J kg-1) and CIN (-250 J kg-1). These parcel constraints are meant to confine the SRH layer calculation to the part of a sounding where lifted parcels are buoyant, but not too strongly capped.
						</li></ul>
				</ul>
				<br><br>
				<p style = "font-size:175%"><b><u>Composite Parameters</u></b></p>
				<ul>
					<br>
					<li style = "font-size:135%", align = "left"><b>Effective SigTor</b></li>
						<ul><li align = "left">Significant Tornado Parameter (effective layer)<br>
					...
					<li style = "font-size:135%", align = "left"><b>Non-Supercell Tornado</b></li>
						<ul><li align = "left">The non-supercell tornado parameter (NST) is the normalized product of the following terms:<br>
					...
					<li style = "font-size:135%", align = "left"><b>Bunkers Right & Right Motions</b></li>
					...
					<li style = "font-size:135%", align = "left"><b>Deviant Tornado Motion</b></li>
						<ul><li align = "left">This parameter was derived by Cameron Nixon and is described in the February 2021 issue of <a href = "https://journals.ametsoc.org/view/journals/wefo/36/1/WAF-D-20-0056.1.xml" target="_blank"><i>Weather and Forecasting</i></a>
						</li></ul>
				</ul>
			</div>
		</div>
